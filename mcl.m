function [S,outliers] = mcl(S,R,Q,z,t_waypoint_pass,map,Lambda_psi,delta_t,t)

%set next action
[v bearing_omega pitch_omega]=setActuators(S,map,t_waypoint_pass,t);
%v=0.1;
%pitch_omega=0;
%bearing_omega=0;

[S_bar] = predict(S,v,bearing_omega,pitch_omega,R,delta_t);
